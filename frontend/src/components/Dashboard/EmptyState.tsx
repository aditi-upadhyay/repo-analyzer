            ...
            <div className="flex items-center flex-1 flex-col border border-slate-200 p-8 rounded-3xl bg-white">
                <div className="flex flex-col items-center gap-6">
                    <div className="flex bg-gray-100 relative size-42 flex items-center justify-center rounded-3xl bg-slate-50">
                        <span className="material-symbols-outlined !text-[8rem] text-primary/40 select-none text-blue-muted">
                            data_object
                        </span>
                        <span className="material-symbols-outlined absolute top-4 right-4 text-primary animate-pulse text-blue-muted">add_circle</span>
                    </div>
