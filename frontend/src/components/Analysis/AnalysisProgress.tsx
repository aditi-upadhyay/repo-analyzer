...
const AnalysisProgress: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-120px)] py-6 px-6 max-w-2xl mx-auto space-y-8 overflow-hidden">
      {error ? (
        <div className="w-full max-w-xl space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="flex flex-col items-center text-center space-y-3">
            <div className="size-16 bg-red-50 rounded-full flex items-center justify-center border-4 border-white shadow-xl shadow-red-500/10">
              <span className="material-symbols-outlined text-red-500 text-3xl font-black">
                priority_high
              </span>
            </div>
            <div className="space-y-1">
              ...
              <p className="text-slate-500 text-sm font-medium max-w-sm mx-auto leading-relaxed">
                The AI model is experiencing high demand. Retrying usually resolves this within a minute.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-[2rem] overflow-hidden shadow-xl shadow-slate-200/50">
            <div className="px-5 py-3 bg-slate-50/50 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-slate-900">Error details</span>
              </div>
              <span className="text-[9px] font-black font-mono text-slate-400 tracking-widest uppercase">
            ...
            <div className="p-5 grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Triggered at</span>
                <p className="text-xs font-bold text-slate-900 font-mono">
                  {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                </p>
              </div>
              <div className="space-y-1">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Repository</span>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 w-fit px-2 py-0.5 bg-red-50 border border-red-100/50 rounded-full text-red-600">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 py-3 bg-slate-100 text-slate-700 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-slate-200 transition-all border border-slate-200/50"
            >
            ...
            <Link
              to="/dashboard"
              className="flex-1 py-3 bg-blue-secondary text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-blue-primary transition-all shadow-lg shadow-blue-600/20"
            >
              Dashboard
